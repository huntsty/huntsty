...
function iron_enqueue_styles() {
	...
	// custom page title
	iron_enqueue_style('page-banner', IRON_PARENT_URL . '/css/page-banner.css', false, NULL, 'all' );
...
*/
	...
	if(get_iron_option('enable_nice_scroll')) {
		 iron_enqueue_script('gambit-smoothscroll', IRON_PARENT_URL.'/js/gambit-smoothscroll.js', null, true);
	}
