...
<?php	if ( get_field('alb_store_list') ) : ?>
					<div class="buttons-block">
						<div class="release-date"><?php echo __("Release Date", IRON_TEXT_DOMAIN); ?>: <span><?php echo date_format(date_create(get_field('alb_release_date')), get_option('date_format')); ?></span></div>
