...
// QUICK FIX - ENCODING MIXMATCH
		$tempo = $this->private_user_data( 'wp-list-themes', $this->user_name, '', $allow_cache, $timeout );
    foreach($tempo as $theme) {
      $theme->theme_name = str_replace('���', '—', $theme->theme_name);
    }
    return $tempo;
