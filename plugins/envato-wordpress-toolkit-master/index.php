            ...
            if ( ! empty( $item_details ) ) {
              ...
              if ( $has_update ) {
                if ( ! current_user_can( 'update_themes' ) ) {
                  ...
                  $content.= sprintf( '<div class="updated below-h2"><p><strong>' . __( 'There is a new version of %1$s available. <a href="%2$s" class="thickbox thickbox-preview" title="%1$s">View version %3$s details</a> or <a href="%4$s" %5$s>update automatically</a> <br><font color="red">(Make sure to DEACTIVATE and DELETE the theme before updating it)</font>.', 'envato' ) . '</strong></p></div>', $title, $details_url, $latest_version, $update_url, $update_onclick );
                }
              } else if ( ! $installed ) {
                if ( ! current_user_can( 'update_themes' ) ) {
                  ...
                  $content.= sprintf( '<div class="updated below-h2"><p><strong>' . __( '%1$s has not been installed. <a href="%2$s" class="thickbox thickbox-preview" title="%1$s">View version %3$s details</a> or <a href="%4$s">install automatically</a> <br><font color="red">(Make sure to DEACTIVATE and DELETE the theme before installing it)</font>.', 'envato' ) . '</strong></p></div>', $title, $details_url, $latest_version, $install_url );
                }
              }
